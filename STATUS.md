...
Generated: `2026-08-10T16:00:05.908964+00:00` by `scripts/status_report.py`
...
|---|---|---|---|---|---|---|---|---|---|
| msb-v3 | T5 ADVERSARIAL | **VERIFIED** | PASS | pass | 70.8% | 70.0%/65% | True | 2.7h | success |
| agent-reach | T5 ADVERSARIAL | **VERIFIED** | PASS | pass | 67.5% | 84.0%/75% | True | 9.0h | success |
| sovereign-mcp-os | T5 ADVERSARIAL | **VERIFIED** | PASS | pass | 66.7% | 94.0%/90% | True | 2.1h | success |
| sovereign-outcome-engine | T5 ADVERSARIAL | **VERIFIED** | PASS | pass | 55.0% | 74.0%/70% | True | 1.7h | success |
| nexus | T5 ADVERSARIAL | **VERIFIED** | PASS | pass | 50.7% | 61.0%/60% | True | 2.1h | success |
| domain-router | T5 ADVERSARIAL | **VERIFIED** | PASS | pass | 56.9% | - | True | 0.0h | success |
| skill-orchestration-os | T5 ADVERSARIAL | **VERIFIED** | PASS | pass | 54.9% | - | True | 0.0h | success |
...
- `domain-router`: 23 passed in 0.17s
- `skill-orchestration-os`: 27 passed, 2 warnings in 1.42s

## Why
- `msb-v3`: gate PASS, artifact age 2h
- `agent-reach`: gate PASS, artifact age 8h
- `sovereign-mcp-os`: gate PASS, artifact age 2h
- `sovereign-outcome-engine`: gate PASS, artifact age 1h
- `nexus`: gate PASS, artifact age 2h
