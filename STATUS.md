...
Generated: `2026-08-10T12:43:00.372503+00:00` by `scripts/status_report.py`
...
|---|---|---|---|---|---|---|---|---|---|
| msb-v3 | T4 INTEGRATED | **VERIFIED** | PASS | pass | - | 70.0%/65% | False | 0.0h | - |
| agent-reach | T5 ADVERSARIAL | **VERIFIED** | PASS | pass | 67.5% | 84.0%/75% | True | 5.7h | - |
| sovereign-mcp-os | T4 INTEGRATED | **VERIFIED** | PASS | pass | - | 94.0%/85% | True | 5.7h | - |
| sovereign-outcome-engine | T4 INTEGRATED | **VERIFIED** | PASS | pass | - | 77.0%/65% | True | 4.7h | success |
| nexus | T4 INTEGRATED | **VERIFIED** | PASS | pass | - | 61.0%/60% | True | 4.7h | success |
| domain-router | T4 INTEGRATED | **VERIFIED** | PASS | pass | - | - | True | 4.6h | - |
| skill-orchestration-os | T4 INTEGRATED | **VERIFIED** | PASS | pass | - | - | True | 4.6h | - |
...
- `nexus`: gate PASS, artifact age 4h
- `domain-router`: gate PASS, artifact age 4h
- `skill-orchestration-os`: gate PASS, artifact age 4h
